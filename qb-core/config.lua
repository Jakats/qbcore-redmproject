...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = {['cash'] = 10, ['bank'] = 100} -- ['type']=startamount - Add or remove money types for your server (for ex. ['blackmoney']=0), remember once added it will not be removed from the database!
